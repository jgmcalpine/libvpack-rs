...
const CARD_CLASSES =
  'rounded-lg border-2 border-dashed border-slate-400 dark:border-slate-700 bg-slate-50/60 dark:bg-slate-800/40 p-6 hidden md:block';
    ...
    <>
      <div className={CARD_CLASSES} role="status" aria-label="Getting started">
        ...
        <p className={BODY_CLASSES}>
          Select <strong>The Virtual Network</strong> or <strong>The Fluid Chain</strong> above
